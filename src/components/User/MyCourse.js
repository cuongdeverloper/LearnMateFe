...
import { finishBooking, getMaterialsByBookingId, getMyBookings, getMyWeeklySchedules, markScheduleAttendance } from '../../Service/ApiService';
  ...
  <>
    ...
    >
      Viết đánh giá
                ...
                {!booking.completed && booking.numberOfSessions > 0 && (
                  <button
